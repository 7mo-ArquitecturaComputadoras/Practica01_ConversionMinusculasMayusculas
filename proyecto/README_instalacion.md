...
Guía paso a paso para clonar, compilar y ejecutar la **Práctica 01 — Conversión de Minúsculas a Mayúsculas** en un equipo nuevo. Esta práctica está escrita en **ensamblador x86 (MASM)** y se compila con **Visual Studio** en **Windows**.
...
2. Haz doble clic sobre **`Practica01_ConversionMinusculasMayusculas.slnx`**.
...
1. En el **Explorador de soluciones** (panel derecho), haz clic derecho sobre el proyecto **Practica01_ConversionMinusculasMayusculas**.
...
El ejecutable se generará en `proyecto/Debug/Practica01_ConversionMinusculasMayusculas.exe`.
...
4. Ve al menú **Depurar** → **Ventanas** → **Memoria** → **Memoria 1**.
...
| El `.slnx` no abre | Versión de Visual Studio anterior a 2022 17.10 | Abre directamente `Practica01_ConversionMinusculasMayusculas.vcxproj` |
